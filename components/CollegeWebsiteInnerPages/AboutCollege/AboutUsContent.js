          ...
          <div className="row align-items-center">
            <div className="col-xl-6">
              <div className="cw-about-us-img">
                <img src="/images/college-website/about-2.jpg" alt="about" />
              </div>
            </div>
            ...
            <div className="col-xl-6">
              <div className="cw-about-us-text">
                <div className="cw-content">
                  <h3 className="playfair-display-font">Our students</h3>
                ...
                <div className="cw-content">
                  <h3 className="playfair-display-font">Our purpose</h3>
