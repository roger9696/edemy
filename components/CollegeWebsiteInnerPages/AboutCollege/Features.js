      ...
      <div className="cw-features pt-100 pb-70 position-relative">
        <div className="container">
          <div className="section-title">
            <h2 className="playfair-display-font">The power of features</h2>
          </div>
          ...
          <div className="row justify-content-center">
            <div className="col-lg-3 col-sm-6">
              <div className="cw-feature-card text-center">
                <div className="icon">
                  <img src="/images/college-website/icon5.png" alt="icon" />
                </div>
                <h3 className="playfair-display-font">Academic transfer</h3>
              </div>
            </div>
            ...
            <div className="col-lg-3 col-sm-6">
              <div className="cw-feature-card text-center">
                <div className="icon">
                  <img src="/images/college-website/icon6.png" alt="icon" />
                </div>
                <h3 className="playfair-display-font">Disclaimers</h3>
              </div>
            </div>
            ...
            <div className="col-lg-3 col-sm-6">
              <div className="cw-feature-card text-center">
                <div className="icon">
                  <img src="/images/college-website/icon7.png" alt="icon" />
                </div>
                <h3 className="playfair-display-font">Academic calendar</h3>
              </div>
            </div>
            ...
            <div className="col-lg-3 col-sm-6">
              <div className="cw-feature-card text-center">
                <div className="icon">
                  <img src="/images/college-website/icon8.png" alt="icon" />
                </div>
                <h3 className="playfair-display-font">Academic success</h3>
              </div>
            </div>
          </div>
        </div>
