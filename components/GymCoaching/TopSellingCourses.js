              ...
              <div className="single-courses-box">
                <div className="courses-image">
                  <Link href="/single-courses-1">
                    <a className="d-block image">
                      <img src="/images/gym/courses-img1.jpg" alt="image" />
                    </a>
                  </Link>
                ...
                <div className="courses-content">
                  ...
                  <h3>
                    <Link href="/single-courses-1">
                      <a>
                        COMPLETE FITNESS TRAINER CERTIFICATION: BEGINNER TO
                        ADVANCED
                      </a>
                    </Link>
                  </h3>
            ...
            <div className="col-xl-4 col-lg-6 col-md-6">
              <div className="single-courses-box">
                <div className="courses-image">
                  <Link href="/single-courses-1">
                    <a className="d-block image">
                      <img src="/images/gym/courses-img2.jpg" alt="image" />
                    </a>
                  </Link>
                  <button type="button" className="fav">
                    <i className="flaticon-heart"></i>
                ...
                <div className="courses-content">
                  ...
                  <h3>
                    <Link href="/single-courses-1">
                      <a>
                        INTERNATIONALLY ACCREDITED DIPLOMA CERTIFICATE IN
                        FITNESS
                      </a>
                    </Link>
                  </h3>
            ...
            <div className="col-xl-4 col-lg-6 col-md-6">
              <div className="single-courses-box">
                <div className="courses-image">
                  <Link href="/single-courses-1">
                    <a className="d-block image">
                      <img src="/images/gym/courses-img3.jpg" alt="image" />
                    </a>
                  </Link>
                  <button type="button" className="fav">
                    <i className="flaticon-heart"></i>
                ...
                <div className="courses-content">
                  ...
                  <h3>
                    <Link href="/single-courses-1">
                      <a>BODYWEIGHT WORKOUT: BUILD MUSCLE WITHOUT A GYM</a>
                    </Link>
                  </h3>
