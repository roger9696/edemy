              ...
              <div className="single-courses-box">
                <div className="courses-image">
                  <Link href="/single-courses-1">
                    <a className="d-block image">
                      <img src="/images/motivation/img1.jpg" alt="image" />
                    </a>
                  </Link>
                ...
                <div className="courses-content">
                  ...
                  <h3 className="jost-font font-weight-bold">
                    <Link href="/single-courses-1">
                      <a>Deep Learning Hands-on Artificial Networks</a>
                    </Link>
                  </h3>
                  <p>
            ...
            <div className="col-xl-4 col-lg-6 col-md-6">
              <div className="single-courses-box">
                <div className="courses-image">
                  <Link href="/single-courses-1">
                    <a className="d-block image">
                      <img src="/images/motivation/img2.jpg" alt="image" />
                    </a>
                  </Link>
                  <button type="button" className="fav">
                    <i className="flaticon-heart"></i>
            ...
            <div className="col-xl-4 col-lg-6 col-md-6">
              <div className="single-courses-box">
                <div className="courses-image">
                  <Link href="/single-courses-1">
                    <a className="d-block image">
                      <img src="/images/motivation/img3.jpg" alt="image" />
                    </a>
                  </Link>
                  <button type="button" className="fav">
                    <i className="flaticon-heart"></i>
                ...
                <div className="courses-content">
                  ...
                  <h3 className="jost-font font-weight-bold">
                    <Link href="/single-courses-1">
                      <a>The Data Science Course 2023: Complete Data</a>
                    </Link>
                  </h3>
                  <p>
