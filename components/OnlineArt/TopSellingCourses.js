            ...
            <div className="col-lg-4 col-md-6">
              <div className="single-courses-box">
                ...
                <div className="courses-content">
                  ...
                  <h3>
                    <Link href="/single-courses-1">
                      <a>Complete Beginner's Guide to Digital Art</a>
                    </Link>
                  </h3>
            ...
            <div className="col-lg-4 col-md-6">
              <div className="single-courses-box">
                ...
                <div className="courses-content">
                  ...
                  <h3>
                    <Link href="/single-courses-1">
                      <a>How to Draw Cute Cartoon Characters</a>
                    </Link>
                  </h3>
            ...
            <div className="col-lg-4 col-md-6">
              <div className="single-courses-box">
                ...
                <div className="courses-content">
                  ...
                  <h3>
                    <Link href="/single-courses-1">
                      <a>Learn How to Make a Retro Digital Collage</a>
                    </Link>
                  </h3>
                  <p>
                    Lorem ipsum dolor sit amet consectetur adipiscing elit sed
            ...
            <div className="col-lg-4 col-md-6">
              <div className="single-courses-box">
                ...
                <div className="courses-content">
                  ...
                  <h3>
                    <Link href="/single-courses-1">
                      <a>Draw, Sketch, Paint, and Design on Your iPad</a>
                    </Link>
                  </h3>
            ...
            <div className="col-lg-4 col-md-6">
              <div className="single-courses-box">
                ...
                <div className="courses-content">
                  ...
                  <h3>
                    <Link href="/single-courses-1">
                      <a>Building Confidence Think Drawing: Art of Beginners</a>
                    </Link>
                  </h3>
