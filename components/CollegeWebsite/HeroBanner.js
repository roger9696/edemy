          ...
          <div className="row align-items-end">
            <div className="col-lg-12 col-xl-12 col-xxl-5 p-0">
              <div className="hero-img">
                <img src="/images//college-website/hero-img1.jpg" alt="hero" />
              </div>
            </div>
                    ...
                    <div className="cw-banner-box">
                      <div className="cw-banner-content">
                        <h1 className="playfair-display-font">
                          Start your journey with our college
                        </h1>

                        <p>
                          Flexible easy to access learning opportunities can
                          bring a significant change in how individuals prefer
                          to learn! The eDemy can offer you to enjoy the
                          beauty of eLearning!
                        </p>
                        ...
                        <div>
                          ...
                          <Link href="#">
                            <a className="default-btn cw-btn active">
