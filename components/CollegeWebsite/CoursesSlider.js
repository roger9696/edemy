              ...
              <div className="cw-courses-item">
                <div className="cw-courses">
                  <div className="img">
                    ...
                    <div className="icon">
                      <img src="/images/college-website/icon1.png" alt="icon" />
                    </div>
                  </div>
              ...
              <div className="cw-courses-item">
                <div className="cw-courses">
                  <div className="img">
                    ...
                    <div className="icon">
                      <img src="/images/college-website/icon2.png" alt="icon" />
                    </div>
                  </div>
                  <h3 className="playfair-display-font">
                    <Link href="/single-courses-1">
              ...
              <div className="cw-courses-item">
                <div className="cw-courses">
                  <div className="img">
                    ...
                    <div className="icon">
                      <img src="/images/college-website/icon3.png" alt="icon" />
                    </div>
                  </div>
                  <h3 className="playfair-display-font">
                    <Link href="/single-courses-1">
              ...
              <div className="cw-courses-item">
                <div className="cw-courses">
                  <div className="img">
                    ...
                    <div className="icon">
                      <img src="/images/college-website/icon4.png" alt="icon" />
                    </div>
                  </div>
                  <h3 className="playfair-display-font">
                    <Link href="/single-courses-1">
