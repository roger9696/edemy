            ...
            <div className="col-lg-6">
              <div className="cw-upcoming-events">
                ...
                <p>
                  ...
                  amet dui. Nulla porttitor accumsan tincidunt.
                </p>

                <div className="image">
                  <img src="/images/college-website/events.jpg" alt="events" />
                      ...
                      <div className="cw-content">
                        ...
                        <h4 className="playfair-display-font">
                          <Link href="/single-events">
                            <a>
                              Annual art competition event - eDemy college hall
                            </a>
                          </Link>
                        </h4>
                      </div>
                        ...
                        <h4 className="playfair-display-font">
                          <Link href="/single-events">
                            <a>
                              ...
                              administration - eDemy college hall
                            </a>
                          </Link>
                        </h4>
                      </div>
                    ...
                    <div className="col-8">
                      <div className="cw-content">
                        ...
                        <h4 className="playfair-display-font">
                          <Link href="/single-events">
                            <a>
                              Event on how to fix student struggle - eDemy
                              college hall
                            </a>
                          </Link>
                        </h4>
