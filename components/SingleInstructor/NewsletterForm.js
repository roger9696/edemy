    ...
    <>
      <div className="instructor-subscribe-area ptb-100">
          ...
          <div className="row justify-content-center align-items-center">
            <div className="col-lg-6 col-md-12">
              <div className="instructor-subscribe-content">
                ...
                <h3 className="el-messiri-font">Subscribe To Our Newsletter</h3>
                <p>
        ...
        <div className="instructor-subscribe-shape-1">
          <img src="/images/instructor-home/subscribe-shape1.png" alt="image" />
        </div>
        <div className="instructor-subscribe-shape-2">
          <img src="/images/instructor-home/subscribe-shape2.png" alt="image" />
        </div>
      </div>
    </>
  );
