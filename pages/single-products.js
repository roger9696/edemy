					...
					<div className="row align-items-center">
						...
						<div className="col-lg-7 col-md-12">
							<div className="products-details-desc">
								...
								<p>
									This story, dazzling in its powerful
									simplicity and soul-stirring wisdom, is
									about an Andalusian shepherd boy named
									Santiago who travels from his homeland in
									Spain to the Egyptian desert in search of a
									treasure buried near the Pyramids. Lorem
